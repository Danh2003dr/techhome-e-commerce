        ...
        <>
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-4">
              <Link
                to="/"
                className="px-8 py-3.5 bg-indigo-600 text-white font-bold rounded-2xl hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-200"
              >
                Go to Homepage
              </Link>
              <Link
                to="/"
                className="px-8 py-3.5 bg-white text-gray-700 font-bold rounded-2xl border border-gray-200 hover:border-indigo-600 transition-all"
              >
                Browse Categories
              </Link>
            </div>
