...
const ForgotPasswordPage: React.FC = () => {
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // In a real app: send code to email/phone, then navigate to reset-password
  };

  return (
    <div className="bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-slate-100 min-h-screen">
      <div className="flex min-h-screen overflow-hidden">
        {/* Left: Security Hero (Desktop only) */}
          ...
          <div className="relative z-10 p-12 text-white max-w-lg">
            ...
            <div className="flex items-center gap-4">
              <div className="flex -space-x-2">
                ...
                <div className="h-10 w-10 rounded-full border-2 border-primary bg-blue-600 flex items-center justify-center overflow-hidden text-xs font-bold">
                  +10k
                </div>
              </div>
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-6 sm:p-12 md:p-20 bg-background-light dark:bg-background-dark relative">
          ...
          <div className="w-full max-w-md">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div>
                <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2" htmlFor="recovery_identifier">
              ...
              <button
                type="submit"
                className="w-full bg-primary hover:bg-blue-600 text-white font-semibold py-3.5 px-4 rounded-lg shadow-lg shadow-primary/20 transition-all active:scale-[0.98] flex items-center justify-center gap-2"
              >
                <span>Send Code</span>
